...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void periodic() {
        SmartDashboard.putNumber("id6 mesafex", this.getState().Pose.minus(VisionConstants.kTagLayout.getTagPose(6).get().toPose2d()).getTranslation().getX());
        SmartDashboard.putNumber("id6 mesafey", this.getState().Pose.minus(VisionConstants.kTagLayout.getTagPose(6).get().toPose2d()).getTranslation().getY());        
