...
public class AutoBranchandShootL2 extends Command{
    ...
    public void execute() {
        ...
        Pose2d  currentPose = drivetrain.getState().Pose;
            ...
            PPHolonomicDriveController.overrideXFeedback(() ->output.vxMetersPerSecond);
            PPHolonomicDriveController.overrideYFeedback(() -> output.vyMetersPerSecond);
            PPHolonomicDriveController.overrideRotationFeedback(() -> output.omegaRadiansPerSecond);
